...
namespace AzzyAIConfig
{
    public partial class ExtraControl : UserControl
    {
        ...
        public ExtraControl()
        {
            ...
            {
                // Read the contents of H_Extra.lua and normalize line endings
                _hextra = File.ReadAllText("H_Extra.lua").Replace("\r\n", "\n").Replace("\r", "\n").Replace("\n", Environment.NewLine);
            }
           // Check if the file M_Extra.lua exists
           if (File.Exists("M_Extra.lua"))
           {
                // Read the contents of M_Extra.lua and normalize line endings
                _mextra = File.ReadAllText("M_Extra.lua").Replace("\r\n", "\n").Replace("\r", "\n").Replace("\n", Environment.NewLine);
            }
