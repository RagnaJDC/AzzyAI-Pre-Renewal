        ...
        private TACT_CAST TACT_CAST
        {
            ...
            set
            {
                switch (value)
                {
                    ...
                    // Map all other react types to "React w/Any" for backward compatibility
        ...
        private TACT_DEBUFF TACT_DEBUFF
        {
            get
            {
                switch (comboBoxDebuff.SelectedIndex + comboBoxDebuff2.SelectedIndex * 2)
                {
                    ...
                    case 2:
                        return TACT_DEBUFF.DEBUFF_NEVER;  // "Never" + "Attacking"
                    case 3:
                        return TACT_DEBUFF.DEBUFF_ANY_A;   // "Any" + "Attacking"
                }
                return TACT_DEBUFF.DEBUFF_NEVER;
            }
            set
            {
                switch (value)
                {
                    ...
                    // Map homunculus-specific debuff types to "Any" with appropriate timing
        ...
        private TACT_SKILLCLASS TACT_SKILLCLASS
        {
            ...
            set
            {
                switch (value)
                {
                    ...
                    // Map all other skill class types to "Any skill" for backward compatibility
