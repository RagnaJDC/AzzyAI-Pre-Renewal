...
namespace AzzyAIConfig
{
    ...
    class MerConf
    {
        ...
        public void Save(string file)
        {
            ...
            M_Config.PickUpBraggi = Convert.ToInt32(_PickUpBraggi);
            M_Config.PickUpDancer = Convert.ToInt32(_PickUpDancer);
            ...
            M_Config.UseSkillOnFollow = Convert.ToInt32(_UseSkillOnFollow);
        ...
        void InitValues()
        {
            ...
            _PickUpBraggi = Convert.ToBoolean(M_Config.PickUpBraggi);
            _PickUpDancer = Convert.ToBoolean(M_Config.PickUpDancer);
            ...
            _UseSkillOnFollow = Convert.ToBoolean(M_Config.UseSkillOnFollow);
        ...
        [Category("AutoSkill Options"),
        Description(
            "Set this to true if you want your mercenary to use skills " +
            "while following (not attacking). This allows skills to be used " +
            "while the mercenary is moving to follow you."
            ),
        DefaultValue(false)]
