...
namespace AzzyAIConfig
{
	...
	// Pre-Renewal version - Basic homunculus types only (for Castle route/defend features)
    ...
    class HomConf
    {
        ...
        public void SetDefaults()
        {
            ...
            _PickUpBraggi = Convert.ToBoolean(((DefaultValueAttribute)TypeDescriptor.GetProperties(this)["PickUpBraggi"].Attributes[typeof(DefaultValueAttribute)]).Value);
            _PickUpDancer = Convert.ToBoolean(((DefaultValueAttribute)TypeDescriptor.GetProperties(this)["PickUpDancer"].Attributes[typeof(DefaultValueAttribute)]).Value);
            ...
            _UseSkillOnFollow = Convert.ToBoolean(((DefaultValueAttribute)TypeDescriptor.GetProperties(this)["UseSkillOnFollow"].Attributes[typeof(DefaultValueAttribute)]).Value);
            ...
            // GUI no longer initializes S-type skill level defaults here; AI controls these values.
        ...
        public void Save(string file)
        {
            ...
            H_Config.PickUpBraggi = Convert.ToInt32(_PickUpBraggi);
            H_Config.PickUpDancer = Convert.ToInt32(_PickUpDancer);
            ...
            H_Config.UseSkillOnFollow = Convert.ToInt32(_UseSkillOnFollow);
        ...
        void InitValues()
        {
            ...
            _PickUpBraggi = Convert.ToBoolean(H_Config.PickUpBraggi);
            _PickUpDancer = Convert.ToBoolean(H_Config.PickUpDancer);
            ...
            _UseSkillOnFollow = Convert.ToBoolean(H_Config.UseSkillOnFollow);
        ...
        DefaultValue(false),
        Browsable(false)] // Hidden in Pre-Renewal version - S-type skill
        ...
        bool _PickUpBraggi = true;
        [Category("Basic Options"),
        Description(
            "Enable picking up Bard's Braggart's Poem buff when available. " +
            "When both Braggart's Poem and Dancer's Impressive Riff are present, " +
            "Braggart's Poem takes priority for optimal performance."
            ),
        DefaultValue(true)]
        public bool PickUpBraggi
        {
            get { return _PickUpBraggi; }
            set { _PickUpBraggi = value; }
        }

        bool _PickUpDancer = true;
        [Category("Basic Options"),
        Description(
            "Enable picking up Dancer's Impressive Riff buff when available. " +
            "When both buffs are present, Braggart's Poem takes priority. " +
            "When only Impressive Riff is available, it will be used."
            ),
        DefaultValue(true)]
        public bool PickUpDancer
        {
        ...
        // Pre-Renewal Version: Basic homunculus type detection for Castle route/defend features
        OldHomunTypeOptions _OldHomunType = OldHomunTypeOptions.Filir;
        [Category("Basic Options"),
        Description(
            "Set this to your homunculus type for Castle route and Castle defend features. " +
            "The AI will auto-detect Vanilmirth, but may need manual setting for other types. " +
            "Only affects Amistr's Castle skill usage for movement and defense."
            ),
        ...
        bool _UseSkillOnFollow = false;
        [Category("AutoSkill Options"),
        Description(
            "Set this to true if you want your homunculus to use skills " +
            "while following (not attacking). This allows skills to be used " +
            "while the homunculus is moving to follow you."
            ),
        DefaultValue(false)]
        public bool UseSkillOnFollow
        {
        ...
        public int AutoSkillDelay
	{
        ...
        DefaultValue(true),
        Browsable(false)] // Hidden in Pre-Renewal version
