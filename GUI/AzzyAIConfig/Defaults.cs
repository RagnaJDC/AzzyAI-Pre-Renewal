...
namespace AzzyAIConfig
{
    static class Defaults
    {
        public static void Load(string fileName)
        {
            ...
            { _UseSkillOnFollow = Convert.ToInt32(Regex.Match(file, "UseSkillOnFollow\\s*=\\s*(\\d+|-\\d+)", RegexOptions.Multiline).Value.Split('=')[1].Trim()); }
        ...
        public static int UseSkillOnFollow
        {
